...
OSErr 	DrawCompleteProc(Movie theMovie, long refCon){
	...
	ofVideoPlayerGst * ofvp = (ofVideoPlayerGst *)refCon;
...
//---------------------------------------------------------------------------
ofVideoPlayerGst::ofVideoPlayerGst (){
...
//---------------------------------------------------------------------------
unsigned char * ofVideoPlayerGst::getPixels(){
...
ofTexture & ofVideoPlayerGst::getTextureReference(){
	if(!tex.bAllocated() ){
		ofLog(OF_LOG_VERBOSE, "ofVideoPlayerGst - getTextureReference - texture is not allocated");
	}
	return tex;
}
...
//---------------------------------------------------------------------------
bool ofVideoPlayerGst::isFrameNew(){
	return bIsFrameNew;
...
//--------------------------------------------------------------------
void ofVideoPlayerGst::update(){
	idleMovie();
}

//---------------------------------------------------------------------------
void ofVideoPlayerGst::idleMovie(){
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::closeMovie(){
...
void ofVideoPlayerGst::createImgMemAndGWorld(){
	Rect movieRect;
	movieRect.top 			= 0;
	movieRect.left 			= 0;
...
//---------------------------------------------------------------------------
bool ofVideoPlayerGst::loadMovie(string name){
	...
	#else
	//--------------------------------------
    ofLog(OF_LOG_VERBOSE,"using GStreamer!");
		...
		if(gstUtils.loadMovie(name)){
			...
			bLoaded = true;
			allocated = true;
			ofLog(OF_LOG_VERBOSE,"ofVideoPlayerGst: movie loaded");
			return true;
		}else{
			ofLog(OF_LOG_ERROR,"ofVideoPlayerGst couldn't load %s",name.c_str());
			return false;
		}
...
//--------------------------------------------------------
void ofVideoPlayerGst::setVolume(int volume){
...
//--------------------------------------------------------
void ofVideoPlayerGst::setLoopState(int state){
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::setPosition(float pct){
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::setFrame(int frame){
...
//---------------------------------------------------------------------------
float ofVideoPlayerGst::getDuration(){
...
//---------------------------------------------------------------------------
float ofVideoPlayerGst::getPosition(){
...
//---------------------------------------------------------------------------
int ofVideoPlayerGst::getCurrentFrame(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
	int frame = 0;
...
//---------------------------------------------------------------------------
bool ofVideoPlayerGst::getIsMovieDone(){
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::firstFrame(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
	setFrame(0);
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::nextFrame(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::previousFrame(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
	setFrame(getCurrentFrame() - 1);
...
//---------------------------------------------------------------------------
void ofVideoPlayerGst::setSpeed(float _speed){
...
//---------------------------------------------------------------------------
float ofVideoPlayerGst::getSpeed(){
	return speed;
}

//---------------------------------------------------------------------------
void ofVideoPlayerGst::setPaused(bool _bPause){
...
//------------------------------------
void ofVideoPlayerGst::setUseTexture(bool bUse){
	bUseTexture = bUse;
}
...
//----------------------------------------------------------
void ofVideoPlayerGst::setAnchorPercent(float xPct, float yPct){
    if (bUseTexture)tex.setAnchorPercent(xPct, yPct);
}

//----------------------------------------------------------
void ofVideoPlayerGst::setAnchorPoint(int x, int y){
    if (bUseTexture)tex.setAnchorPoint(x, y);
}

//----------------------------------------------------------
void ofVideoPlayerGst::resetAnchor(){
   	if (bUseTexture)tex.resetAnchor();
}

//------------------------------------
void ofVideoPlayerGst::draw(float _x, float _y, float _w, float _h){
	if (bUseTexture){
...
//------------------------------------
void ofVideoPlayerGst::draw(float _x, float _y){
	draw(_x, _y, (float)width, (float)height);
}

//------------------------------------
int ofVideoPlayerGst::getTotalNumFrames(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
	return nFrames;
...
//----------------------------------------------------------
float ofVideoPlayerGst::getHeight(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
	return (float)height;
...
//----------------------------------------------------------
float ofVideoPlayerGst::getWidth(){
	//--------------------------------------
	#ifdef OF_VIDEO_PLAYER_QUICKTIME
	//--------------------------------------
	return (float)width;
